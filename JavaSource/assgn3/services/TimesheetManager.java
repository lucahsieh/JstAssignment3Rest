...
@Path("/employees/{empId}/timesheets")
@Dependent
@Stateless
...
//  @Produces("application/xml")
    public Timesheet[] getAll(@PathParam("empId") int empId) {
        TypedQuery<Timesheet> query = 
                em.createQuery("SELECT ts FROM Timesheet ts WHERE ts.EmpNumber = :empId ", Timesheet.class)
